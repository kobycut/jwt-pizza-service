...
orderRouter.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    await metrics.trackRequestLatency(interval);
  })
);
...
orderRouter.post(
  "/",
  metrics.track("post"),
  metrics.track("attemptedPurchase"),
  authRouter.authenticateToken,
  ...
  asyncHandler(async (req, res) => {
    ...
    if (r.ok) {
      metrics.trackSuccessPurchases("successfullPizzaPurchase");
      latencyEnd = new Date();
    ...
    metrics.trackPrice(price);
    metrics.trackPizzaLatency(latencyEnd - latencyStart);
  })
);
